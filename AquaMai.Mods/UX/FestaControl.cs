...
{
    [ConfigSection("Festa 开关",
                      zh: "控制 “Festa” 模式 UI 的显示。如不开启，则不会更改设置，由 Event 或者服务器控制",
                      en: "Control the display of “Festa” mode UI. If not enabled, the settings will not be changed, and Event or server will control it"), EnableGameVersion(26000)]
    public static class FestaControl
    {
        [ConfigEntry("启用 Festa",
                        zh: "是否显示 “Festa” 模式 UI",
...
#endif
        [HarmonyPrefix, HarmonyPatch(typeof(GetPresentProcess), "CreateFestaBorderRewardListOpenFesta")]
        public static bool CreateFestaBorderRewardListOpenFesta() => false;
#if SDEZ
        [HarmonyPrefix]
